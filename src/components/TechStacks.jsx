...
const TechStacks = () => {
  return (
    <div
      className="px-5 py-20 bg-primary-blue text-aqua-color md:px-20"
      id="stacks"
    >
      <h4
        className="mb-5 text-3xl font-semibold text-center md:text-left text-main-heading-color"
        data-aos="fade-up"
      ...
      <div
        className="flex flex-wrap items-center justify-center gap-10 mt-5"
        data-aos="fade-up"
        data-aos-duration="1000"
      >
        {/* HTML5 */}
